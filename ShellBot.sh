...
#	SCRIPT:				ShellBot.sh
#	VERSÃO:				6.4.0
#	DESENVOLVIDO POR:	EL MANDARIN SNIFF [GATESCCN]
#	PÁGINA:				NO TENEMOS XD
#	FANPAGE:			https://www.facebook.com/VPSMXSBOT
#	GITHUB:				https://github.com/GATESCCN
# 	CONTATO:			gateccn@gmail.com
#
...
#						reduzindo o nível de dependências de pacotes externos. el proyecto origi tenia bugs y estaba en portugues xd 
#-----------------------------------------------------------------------------------------------------------
